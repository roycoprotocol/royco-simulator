...
export default function DayFrontendPage() {
  ...
  return (
    <div style={{ fontFamily: 'var(--font-inter)', background: 'var(--foundation)', color: 'var(--theme-foreground)' }} className="min-h-screen">
      {/* thin top bar: back link + layout toggle */}
      <div className="border-b border-[var(--theme-border)] px-6 py-3 flex items-center justify-between">
        <Link href="/internal" className="text-xs text-[var(--muted-foreground)] hover:text-[var(--theme-foreground)] transition-colors">← Internal</Link>
