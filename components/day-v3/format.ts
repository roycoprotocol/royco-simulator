 ...
 */
export type DayV3Unit = string;

export const isUsdUnit = (unit: DayV3Unit) => unit === "USD";

/** The stake a per-unit readout is quoted against: "$100", or "100" in ETH. */
export const stake100 = (unit: DayV3Unit) => (isUsdUnit(unit) ? "$100" : "100");

/** An exact per-100 figure in the market's own unit. */
export const unitAmount = (value: number, unit: DayV3Unit) =>
 ...
 */
export const unitRatio = (value: number, unit: DayV3Unit) =>
 ...
 * them in.
 */
export const compactAmount = (value: number, unit: DayV3Unit) =>
 ...
 */
export const unitTick = (value: number, unit: DayV3Unit) =>
