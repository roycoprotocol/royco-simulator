      ...
      <CardHeader>
        ...
        <CardDescription>
          {curveOverridden
            ...
            : "How the current scenario changes Junior and SLP's share of Senior yield as their capital is used. These starting curves drive the model and can be customized in Deploy."}
        </CardDescription>
      </CardHeader>
