...
7. Day is strictly additive to Dawn. Preserve all five Dawn controls, the Conservative/Balanced/Aggressive ladder, linked-Junior override, observation-period state and claim erasure, protected-exit threshold, Junior replenishment, the unified two-handle Backtest window scrubber, review metrics, and deploy fields. Day may add Liquidity controls, outputs, and accountant fields; it may not replace, restyle, or remove Dawn behavior.
